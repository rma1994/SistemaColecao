...
import nwk.com.br.structures.JogoStru;
 ...
 */
public class ConsultaJogo extends javax.swing.JInternalFrame {
    private JogoStru stru = new JogoStru();
    private JDesktopPane jDesktopPanePrincipal = new JDesktopPane();
    /**
     * Creates new form ConsultaJogo
     */
    public ConsultaJogo() {
        initComponents();
        atualizaTable();
    ...
    public void addConsultaJogo(JDesktopPane frame){
    ...
    private void jButtonInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonInserirActionPerformed
        CadJogo cadJogo = new CadJogo();
        dispose();
        cadJogo.addCadJogoNew(jDesktopPanePrincipal);
    ...
    private void jTableUsuarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableUsuarioMouseClicked
        ...
        jogo.setCod(Integer.parseInt(jTableUsuario.getValueAt(linhaSelecionada, 0).toString()));
        jogo.setNome(jTableUsuario.getValueAt(linhaSelecionada, 1).toString());
        jogo.setData(jTableUsuario.getValueAt(linhaSelecionada, 2).toString());
        jogo.setPlataforma(jTableUsuario.getValueAt(linhaSelecionada, 3).toString());
        jogo.setUpdate(true);
        
        dispose();
        cadJogo.addCadJogoUpdate(jDesktopPanePrincipal, jogo);
